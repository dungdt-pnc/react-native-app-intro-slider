...
class AppIntroSlider extends React.Component {
    constructor() {
        ...
        this._renderNextButton = () => this.props.showNextButton &&
            this._renderButton('Prochaine', this.props.nextLabel, () => this.goToSlide(this.state.activeIndex + 1, true), this.props.renderNextButton);
        this._renderPrevButton = () => this.props.showPrevButton &&
            this._renderButton('Précédente', this.props.prevLabel, () => this.goToSlide(this.state.activeIndex - 1, true), this.props.renderPrevButton);
        this._renderDoneButton = () => this.props.showDoneButton &&
            this._renderButton('Terminé', this.props.doneLabel, this.props.onDone, this.props.renderDoneButton);
